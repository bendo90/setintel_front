          ...
          >
              ...
              <div class="pt-5" style="width: 80%; margin: auto">
                  ...
                  <div class="pb-5 pt-5">
                      <a
                              href="#"
                              class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-teal-400 rounded-lg focus:ring-4 focus:outline-none "
                      >
                          Read more
                          <svg
          ...
          >
              ...
              <div class="pt-5" style="width: 80%; margin: auto">
                  ...
                  <div class="pb-5 pt-10">
                      <a
                              href="#"
                              class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-teal-400 rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                      >
                          Read more
                          <svg
                                  class="rtl:rotate-180 w-3.5 h-3.5 ms-2"
